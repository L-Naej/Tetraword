 ...
 * 
 * Includes all graphics to display.
 * That is to say the game board with bricks, 
 * the next brick, user score & controls button.
 */
...
public class BoardPanel extends JPanel implements MouseListener {
	...
	public void nextShapePaint(Graphics g) {	  
		  ...
		  switch (board.getBrickFactory().getNextBrickType()){
			  case I:
				  brickDrawer.drawImage(IShape, x, y, null);
				  break;
			  case J:
				  brickDrawer.drawImage(JShape, x, y, null);
				  break;
			  case L:
				  brickDrawer.drawImage(LShape, x, y, null);
				  break;
			  case O:
				  brickDrawer.drawImage(OShape, x, y, null);
				  break;
			  case S:
				  brickDrawer.drawImage(SShape, x, y, null);
				  break;
			  case T:
				  brickDrawer.drawImage(TShape, x, y, null);
				  break;
			  case Z:
				  brickDrawer.drawImage(ZShape, x, y, null);
				  break;
		  }
	...
	public void bricksPaint(Graphics g, int i, int j, Brick brick ) {		
	    ...
	    //Recovered on the type of brick
	    ...
	    switch (type){
		    case I: 
		    	brickDrawer.drawImage(CyanBrick, x, -y, null);
		    	break;
		    case J:  
		    	brickDrawer.drawImage(BlueBrick, x, -y, null);
		    	break;
		    case L:  
		    	brickDrawer.drawImage(OrangeBrick, x, -y, null);
		    	break;
		    case O:  
		    	brickDrawer.drawImage(YellowBrick, x, -y, null);
		    	break;
		    case S:  
		    	brickDrawer.drawImage(GreenBrick, x, -y, null);
		    	break;
		    case T:  
		    	brickDrawer.drawImage(MagentaBrick, x, -y, null);
		    	break;
		    case  Z:  
		    	brickDrawer.drawImage(RedBrick, x, -y, null);
		    	break;
	    }
     ...
     * score, controls button and display commands.
     * @see scorePaint(Graphics g)
     * @see helpPaint(Graphics g)
     * @see commandsPaint(Graphics g)
     ...
     * and place the buffer up-left corner.
     * @see setSize(int width, int height)
     * @see setBounds(int x, int y, int width, int height)
     */
    ...
    /**
     * Listener of the controls button. Check the user clik on.
     */
